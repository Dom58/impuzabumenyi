...
@endsection
 @section('informationBody')
    <div class="col-md-8"  style=" background-color:white; border-radius: 10px; border: 3px solid gray;">
        <h3>Soma Amateka Arambuye y'igikoresho kitwa "<b>{{ $gakondo ->name }}</b>"</h3> 

        <h3 style="color:blue; text-align: center;">{{ $gakondo ->name }} </h3>
        <center>
        <div class="figure">
          <a href="/ibikoreshoGakondo/{{$gakondo ->file_name}}" target="_blank">
        <img src="/ibikoreshoGakondo/{{$gakondo ->file_name}}" class="img-responsive" />
        </a>
        </div>
        </center>
        <br>
