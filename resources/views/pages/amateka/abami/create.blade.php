...
<div class="col-md-8 col-md-offset-1">
      <h2 style="text-align: center;">Andika Amateka y'umwami</h2>  
        <hr>
       {!! Form::open(array('route' => 'abami.store','data-parseley-validate' =>'','files' => true)) !!}
          ...
          <div class="panel-body text-center" style="background-color: white; margin-bottom: 25px;">
                ...
                <p>
                 {{ Form::label('image', 'Ifoto yumwami', ['class' => 'form-spacing-top']) }}
                 <p style="color: brown;"><span class="fa fa-warning" style="color:red;"></span> (Ongeraho ifoto y'umwami itarengeje 1.5Mbs)</p>
        ...
        <label>Izina ry'umwami</label>
        {{ Form::text('name',null,array('class' =>'form-control','maxlength'=>'50','placeholder'=>'Andika izina ryumwami...')) }}
        <br>
        
        {{ Form::label('history',"Andika amateka ye:") }}
